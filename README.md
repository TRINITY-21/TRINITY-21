...
<a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=A855F7&width=435&lines=Building+tools+I+actually+want+to+use;Shipping+fast+with+AI;Consuming+every+API+I+can+find;Living+in+the+terminal" alt="Typing SVG" /></a>
...
- ✈️ **[Travel-Planner](https://github.com/TRINITY-21/Travel-Planner)** – Trip planning app with interactive maps. React + Vite + Leaflet + Framer Motion + Tailwind CSS.
...
- 🔗 **[EchoWeb](https://github.com/TRINITY-21/echoweb)** – Discover new artists. Full-stack web project built with TypeScript.
- ⚽ **[Ovalve](https://github.com/TRINITY-21/ovalve)** – Live football matches streaming web application. TypeScript.
